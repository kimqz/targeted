...
def flat(size: Vector3 = Vector3([14.0, 14.0, 0.0])) -> Terrain:
    """
...
# Qinwan: "
def slippery(
        size: Vector3 = Vector3([14.0, 14.0, 0.1]),
        friction: Vector3 = Vector3([0.05, 0.005, 0.00001]),
        # friction reference:friction: real(3), “1 0.005 0.0001”
        ...
        # The friction parameters for the contact pair are combined depending on the solmix and priority attributes,
        # as explained in Contact parameters. https://mujoco.readthedocs.io/en/stable/XMLreference.html#body-geom
        color: Vector3 = Vector3([0.69, 0.93, 0.93]) ) -> Terrain:
    return Terrain(
        static_geometry=[
            geometry.SlipPlane(
                position=Vector3(),
