    ...
    def make_controller(self, body: Body, dof_ids: List[int]) -> ActorController:
        ...
        for ind, hinge in enumerate(active_hinges):
            if body.grid_position(hinge)[1] < 0:
                ...
                #print("left")
                #print(body.grid_position(hinge)[1])
                #print(hinge)
        ...
        # Qinwan commented out the above. added below "
        return ControllerCpg(
            initial_state, cpg_network_structure.num_cpgs, weight_matrix, dof_ranges, jointsLeft, jointsRight, jointsMid
        )
        #"
