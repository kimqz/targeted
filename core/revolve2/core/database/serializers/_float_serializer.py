...
class FloatSerializer(Serializer[float]):
    ...
    async def to_database(
        ...
        items = [DbFloat(
                         ...
                         inverted_target_distance_with_travelled=f['inverted_target_distance_with_travelled'],
                         total_travelled=f['total_travelled'],
    ...
    async def from_database(cls, session: AsyncSession, ids: List[int]) -> List[float]:
        ...
        for i in range(len(items)):
            ...
            measures['inverted_target_distance_with_travelled'] = items[i].inverted_target_distance_with_travelled
            measures['total_travelled'] = items[i].total_travelled
...
class DbFloat(DbBase):
    ...
    inverted_target_distance_with_travelled = sqlalchemy.Column(sqlalchemy.Float, nullable=True)
    total_travelled = sqlalchemy.Column(sqlalchemy.Float, nullable=True)
